...
- IMPORT_PATH (opcional): caminho de import para o DTO (ex.: `../dtos/provider_dto.dart` ou `package:my_app/...`). Se não informado, use o import relativo padrão `../dtos/<entity_em_minusculas>_dto.dart`.
